...
/**
 * This class is only intended to be used with the REST service at localhost.
 * Its main purpose is for unit testing of the REST service interface.
 *
 * @author Anders Lövgren (QNET/BMC CompDept)
 */
public class BatchelorRestLoopback extends BatchelorRestClient {
    ...
    /**
     * Creates an Batchelor REST service client using the REST service on
     * localhost. The object created is only useful for testing.
     *
