...
/**
 * This class describes an newly enqueued job. The stamp is the UNIX time in seconds since the
 * beginning of the UNIX epoch (usually 01:00 1970-01-01). This stamp is the clock on the server
 * where/when the job was enqueued.
 *
...
public class EnqueueResult implements Serializable {
    ...
    /**
     * Creates an enqueue result object with default values for member fields (null and zeroes).
     */
    ...
    public String toString() {
        return String.format(
                "Job ID: %s\t= { Result=%d, Date=%s, Time=%s, Stamp=%s }",
