...
public class LinkObjectConverter {
    ...
    /**
     * Extract the job identity from the link object. A link object from an result request has
     * '/result/jobid' as its last components of the href.
     *
    ...
    /**
     * Extract the relative file path of the link object given the job identity object.
     *
    ...
    public static String createFilePath(Link link, JobIdentity job) {
        String find = String.format("%s/%s", job.getResult(), job.getJobID());
