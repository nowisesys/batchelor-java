...
/**
 * The server connection class implementing the HttpServerRequest interface for the HTTP protocol.
 *
 * @author Anders Lövgren (QNET/BMC CompDept)
 */
public class HttpServerConnection implements HttpServerRequest {
    ...
    /**
     * Creates an HTTP server connection using the URL arguement as address. The connection is made
     * thru the proxy server.
     *
     * @param url The URL to open.
