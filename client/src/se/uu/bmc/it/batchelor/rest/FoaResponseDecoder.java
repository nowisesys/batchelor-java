...
/**
 * This class extends the ContentHandler class to decoding FOA encoded response messages from the
 * Batchelor REST service.
 *
 * @author Anders Lövgren (QNET/BMC CompDept)
...
public class FoaResponseDecoder extends ContentHandler {
    ...
    /**
     * This function checks that the entity meets the expected format or an DecoderException is
     * thrown.
     *
    ...
    /**
     * Decode an file object. This function reads the file header, leaving the input stream at the
     * position where the caller can start read the actual file content. The number of bytes to read
     * can be obtained from File.getSize()
     *
     * @param result The result object.
     * @throws se.uu.bmc.it.foa.DecoderException
     * @throws java.io.IOException
    ...
    /**
     * Get next FOA encoded object from input stream (contained in the URL connection).
     *
    ...
    /**
     * Return a result object wrapping an error object. This function extends the result error type
     * with local errors.
     *
