...
/**
 * This class is only intended to be used with the SOAP service used at build time. Its main purpose
 * is for unit testing of the SOAP interface.
 *
 * @author Anders Lövgren (QNET/BMC CompDept)
 */
public class BatchelorSoapLoopback extends BatchelorSoapClient {
    ...
    /**
     * Create an Batchelor SOAP client using the WSDL location at build time. This constructor is
     * only useful for communication with the web service that JAX-WS has generated the client
     * source from.
     *
     * Use this constructor to consume the service at:
     * http://127.0.0.1:8080/BatchelorService/BatchelorSoapService?wsdl
     */
