...
public class FoaResponseDecoderTest {
    ...
    public void testGetContent() {
        ...
        try {
            ...
            URL url = new URL("http://localhost/batchelor1/ws/rest/version?encode=foa");
            ...
            url = new URL("http://localhost/batchelor1/ws/rest/queue/all/data?encode=foa");
            ...
            url = new URL("http://localhost/batchelor1/ws/rest/result?encode=foa");
            connection = (HttpURLConnection) url.openConnection();
            result = (Result) connection.getContent();
            assertNull(result.getError());
            assertEquals("success", result.getState());
            ...
            url = new URL("http://localhost/batchelor1/ws/rest/missing?encode=foa");
            connection = (HttpURLConnection) url.openConnection();
            result = (Result) connection.getContent();
            ...
            url = new URL("http://localhost/batchelor1/notfound.html?encode=foa");
            connection = (HttpURLConnection) url.openConnection();
            connection.connect();
            try {
                // 
            ...
            url = new URL("http://localhost/batchelor1/?encode=foa");
            connection = (HttpURLConnection) url.openConnection();
            connection.connect();
            try {
                // 
